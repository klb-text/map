...
# Branch selector to LOAD mappings from
...
# ---- Always refresh mappings from GitHub on each run, unless modified locally
...
# ---- Search CADS for Unmapped Vehicle (NEW with unique keys) ----
